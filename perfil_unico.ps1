# 1. BLINDAJE PARA GOOGLE CHROME (MODO EFÍMERO TOTAL)
...
# Activar perfiles efímeros: destruye el perfil de la memoria al cerrar el navegador
...
# 2. BLINDAJE PARA MICROSOFT EDGE (MODO EFÍMERO TOTAL)
...
Write-Host "[+] Blindaje Efimero (Sin Bloqueo USB) aplicado correctamente." -ForegroundColor Green
